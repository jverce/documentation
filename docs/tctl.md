...
```
docker run --rm temporalio/tctl:1.4.0 --namespace samples-namespace namespace describe
```
...
```
docker run --network=host --rm temporalio/tctl:1.4.0 --namespace samples-namespace namespace describe
```
...
[here](/docs/server-search-workflows/#memo-vs-search-attributes).
